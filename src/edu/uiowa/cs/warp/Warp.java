...
public class Warp {
   ...
   */
  private static final Double MIN_LQ = 1.0;

  /**
   *  default end-to-end reliability for all flows (commandline option)
   */
  ...
  /**
   * default output subdirectory (from working directory) where output files will be placed (e.g., gv, wf, ra)
   */
