...
class WorkLoadTest {
	 ...
	 * ------------------------------ */
	@Test
	void testSetFlowsInDMorder_StressTest() {
	 ...
	 * ------------------------------ */
	@Test
	void testGetFlowNamesInPriorityOrder_NotEmpty() {
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	...
	@Test
	void testGetFlowNamesInPriorityOrder_Empty() {
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	 ...
	 * ------------------------------ */
	@Test
	void testGetNodeChannel_ValidNode() {
		//instantiation of a new WorkLoad object using StressTest.txt as test file
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	...
	@Test
	public void testGetNodeChannel_InvalidNode() {
	 ...
	 * ------------------------------ */
	@Test
	void testGetNodesInFlow_ValidFlow() {
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	...
	@Test
	void testGetNodesInFlow_InvalidFlow() {
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	 ...
	 * ------------------------------ */
	@Test
	void testSetFlowNamesInOriginalOrder_NotEmpty() {
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	...
	@Test
	void testSetFlowNamesInOriginalOrder_Empty() {
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	 ...
	 * ------------------------------ */
	@Test
	void testMaxFlowLength_StressTest() {
	...
	@Test
	void testMaxFlowLength_WARPMIXSchedule0WarpInput() {
	...
	@Test
	void testMaxFlowLength_LongChain() {
	 ...
	 * ------------------------------ */
	@Test
	void testGetFlowDeadline_Unique() {
		WorkLoad wkld = new WorkLoad(1, 0.9, 0.99, "StressTest.txt");
	...
	@Test
	void testGetFlowDeadline_Default() {
		WorkLoad wkld2 = new WorkLoad(1, 0.9, 0.99, "Example.txt");
	...
	@Test
	void testGetFlowDeadline_InvalidInput() {
	 ...
	 * ------------------------------ */
	@Test
	void testGetNodeNamesOrderedAlphabetically_AllUpperCase() {
	...
	@Test
	void testGetNodeNamesOrderedAlphabetically_UpperAndLowerCase() {
	...
	@Test
	void testGetNodeNamesOrderedAlphabetically_AllNumbers() {
	...
	@Test
	void testGetNodeNamesOrderedAlphabetically_LettersAndNumbers() {
